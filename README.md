...
## Flux Interpretation Cohort Selection Phase

```powershell
python -m arctic_doc_model_rebuild.cli select-flux-analysis-cohorts
python -m arctic_doc_model_rebuild.cli flux-cohort-report
python -m pytest
```
